...
void Opts::addf(char _shortname,const string& _longname,const string& _desc)
{
	Opt opt;
...
void Opts::addf(char _shortname,const string& _desc)
{
	Opt opt;
	opt.shortname = _shortname;
	opt.desc = _desc;
...
void Opts::addf(const string& _longname,const string& _desc)
{
	Opt opt;
	opt.longname = _longname;
	opt.desc = _desc;
