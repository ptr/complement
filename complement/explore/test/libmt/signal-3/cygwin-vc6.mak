...
stldbg-shared:	LDSEARCH = /LIBPATH:${STLPORT_LIB_DIR} /LIBPATH:${CoMT_LIB_DIR_STLDBG} $(MS_LIB_OPT)
dbg-shared:	LDSEARCH = /LIBPATH:${STLPORT_LIB_DIR} /LIBPATH:${CoMT_LIB_DIR_DBG} $(MS_LIB_OPT)
