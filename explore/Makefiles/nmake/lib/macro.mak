# -*- makefile -*- Time-stamp: <03/09/28 19:10:43 ptr>
# $Id$
...
LIB_NAME        = $(LIBNAME)_$(COMPILER_NAME).$(LIB)
...
LIB_NAME_DBG    = $(LIBNAME)_$(COMPILER_NAME)$(DBG_SUFFIX).$(LIB)
...
LIB_NAME_STLDBG    = $(LIBNAME)_$(COMPILER_NAME)_stl$(DBG_SUFFIX).$(LIB)
...
# Static libraries:
A_NAME = $(LIBNAME)_$(COMPILER_NAME)s.$(ARCH)
A_NAME_OUT = $(OUTPUT_DIR_A)\$(A_NAME)

A_NAME_DBG = $(LIBNAME)_$(COMPILER_NAME)s$(DBG_SUFFIX).$(ARCH)
A_NAME_OUT_DBG = $(OUTPUT_DIR_A_DBG)\$(A_NAME_DBG)

A_NAME_STLDBG = $(LIBNAME)_$(COMPILER_NAME)_sstl$(DBG_SUFFIX).$(ARCH)
