...
!endif
INSTALL_LIB_DIR        = $(SRCROOT)\build\lib\$(TARGET_LIB_BIN_SUBFOLDER)
INSTALL_LIB_DIR_DBG    = $(SRCROOT)\build\lib\$(TARGET_LIB_BIN_SUBFOLDER)
INSTALL_LIB_DIR_STLDBG = $(SRCROOT)\build\lib\$(TARGET_LIB_BIN_SUBFOLDER)
INSTALL_STATIC_LIB_DIR = $(SRCROOT)\build\lib\$(TARGET_LIB_BIN_SUBFOLDER)
INSTALL_STATIC_LIB_DIR_DBG    = $(SRCROOT)\build\lib\$(TARGET_LIB_BIN_SUBFOLDER)
INSTALL_STATIC_LIB_DIR_STLDBG = $(SRCROOT)\build\lib\$(TARGET_LIB_BIN_SUBFOLDER)
INSTALL_BIN_DIR        = $(SRCROOT)\build\bin\$(TARGET_LIB_BIN_SUBFOLDER)
INSTALL_BIN_DIR_DBG    = $(SRCROOT)\build\bin\$(TARGET_LIB_BIN_SUBFOLDER)
INSTALL_BIN_DIR_STLDBG = $(SRCROOT)\build\bin\$(TARGET_LIB_BIN_SUBFOLDER)
INSTALL_STATIC_BIN_DIR        = $(SRCROOT)\build\bin\$(TARGET_LIB_BIN_SUBFOLDER)
INSTALL_STATIC_BIN_DIR_DBG    = $(SRCROOT)\build\bin\$(TARGET_LIB_BIN_SUBFOLDER)
INSTALL_STATIC_BIN_DIR_STLDBG = $(SRCROOT)\build\bin\$(TARGET_LIB_BIN_SUBFOLDER)
