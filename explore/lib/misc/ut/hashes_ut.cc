...
extern void hashes_test_suite_init( exam::test_suite&, hashes_test& );

int main( int argc, const char** argv )
{
  Opts opts;

  opts.description( "test suite for 'hashes'" );
  opts.usage( "[options]" );
  ...
  exam::test_suite t( "libmisc hashes test" );

  hashes_test test;

  hashes_test_suite_init( t, test );
